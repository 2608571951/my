...
IMAGE_PATH3 = './medical_fused_image01_2/'
FILE_NAME = './test_result_index01_2.txt'
...
def comp_idx():
    ...
    print('SSIM1: {0}; SSIM2: {1}; NMI1: {2}; NMI2: {3}; \nCC1:{4}; CC2:{5}; EN: {6}; SF: {7};'.format(SSIM1, SSIM2, NMI1, NMI2, CC1, CC2, EN, SF))
